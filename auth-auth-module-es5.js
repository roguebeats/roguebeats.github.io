(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
    ...
    function srcAppAuthAuthRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _spotify_auth_spotify_auth_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./spotify-auth/spotify-auth.component */
      "./src/app/auth/spotify-auth/spotify-auth.component.ts");

      var routes = [{
        path: 'authorized',
        component: _spotify_auth_spotify_auth_component__WEBPACK_IMPORTED_MODULE_2__["SpotifyAuthComponent"]
      }];
    ...
    function srcAppAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _spotify_auth_spotify_auth_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./spotify-auth/spotify-auth.component */
      "./src/app/auth/spotify-auth/spotify-auth.component.ts");
    ...
    /***/
    function srcAppAuthSpotifyAuthSpotifyAuthComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SpotifyAuthComponent = /*#__PURE__*/function () {
        function SpotifyAuthComponent(authService, activatedRoute, router) {
        ...
        _createClass(SpotifyAuthComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.activatedRoute.queryParams.subscribe(function (params) {
              if (params.code) {
                _this.authService.getAccessToken(params.code, params.state);
              } else {// this means they declined or it messed up
                // params should have error and state
              }
            });
            this.authService.authorized$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (authorized) {
              return authorized;
      ...
      SpotifyAuthComponent.ɵfac = function SpotifyAuthComponent_Factory(t) {
        return new (t || SpotifyAuthComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };

      SpotifyAuthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SpotifyAuthComponent,
        selectors: [["rbc-spotify-auth"]],
        decls: 2,
        vars: 0,
        template: function SpotifyAuthComponent_Template(rf, ctx) {
          if (rf & 1) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SpotifyAuthComponent, [{
